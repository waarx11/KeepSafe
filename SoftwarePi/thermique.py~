...
class pithermalcam:
    ...
    _colormap_list=['jet','bwr','seismic','coolwarm','PiYG_r','tab10','tab20','gnuplot2','brg','flag_r']
    ...
    def __init__(self,use_f:bool = True, filter_image:bool = False, image_width:int=1200, 
                image_height:int=900, output_folder:str = '/home/pi4/cameraThermique/espoir/photo/'):
        self.use_f=use_f
    ...
    def save_image(self):
        ...
        fname = self.output_folder + 'pic_Thermic_' + dt.datetime.now().strftime('%Y-%m-%d_%H-%M-%S') + '.jpg'
